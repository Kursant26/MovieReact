...
const MovieDetails = () => {
    ...
    const getDetails = (key) => {
        axios(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${key}&language=ru-US`)
            .then((res) => {
                setDetails(res.data)
            })
                ...
                <div className="details">
                    <div className="details--img">
                        {poster_path ?
                            ...
                            : <img
                                src={`https://10play.com.au/ip/s3/2019/08/09/e4b365d10829878d80a0a1871ffeee0b-551003.jpg?image-profile=image_poster&io=portrait&dpr=2${poster_path}`}
                                width={300} alt="img"/>
                        }
                    </div>
